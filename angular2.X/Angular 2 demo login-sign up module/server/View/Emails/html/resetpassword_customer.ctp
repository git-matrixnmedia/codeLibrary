<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="padding-bottom:20px; font-weight:700;">Hello,</div>
    
    <a href="<?php echo $viewData; ?>">Click here to Reset Your Password</a><br/>
 
	<pre>or Visit this Link</pre><br/>
 
	<p><a href="<?php echo $viewData; ?>"><?php echo $viewData; ?></a></p>
