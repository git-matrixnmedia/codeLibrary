<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="padding-bottom:20px; font-weight:700;">Dear Admin,</div>
    
    <p> A new customer has registered on <?php echo $customerData[0]['created_on']; ?>. Following is the details:- </p>
 
    <table>
      <tr><td>Name :</td><td><?php echo $customerData[0]['fullname']; ?></td></tr>
      <tr><td>Email ID :</td><td><?php echo $customerData[0]['email_id']; ?></td></tr>
    </table>
